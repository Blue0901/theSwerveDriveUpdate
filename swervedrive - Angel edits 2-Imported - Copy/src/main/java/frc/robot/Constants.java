...
public final class Constants {
  ...
  public static final class Arm {
    ...
    public static final double kScoringPosition = 0.1; //change this to fix position problems
    public static final double kIntakePosition = -1.22;
  }
  ...
  public static final class Climbers{
    public static final int KleftClimberID = 19;
    public static final int KrightClimberID = 20;

    public static final int kCurrentLimit = 80;

    public static final double kLeftPower = 0.2;
    public static final double kRightPower = 0.2;

    // public static final double kLeftPower = 0.7;
    // public static final double kRightPower = 0.8;
  }

  public static final class Launcher {
    public static final int kTopCanId = 17;
